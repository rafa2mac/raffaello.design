jQuery(function(jQuery) {  
	...
	//jQuery("select#page_template option, .editor-page-attributes__template select").click(function () {
	  	var format = jQuery(this).val();
...
jQuery(document).ready(function(jQuery) {  
	...
	setTimeout(function() {
		...
		jQuery("select#page_template option, .editor-page-attributes__template select option").each(function () { 
			var format = jQuery(this).val();
