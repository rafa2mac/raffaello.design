jQuery(document).ready(function(){
	...
	* 	Checkbox
	*/
	jQuery('.checkbox-status').on("click", function() { 
	...
	jQuery('.checkbox-status-active').on("click", function() { 
		checkbox = jQuery(this).attr('title');
	...
	*/
	...
	jQuery( ".organize-list li a" ).on("click",function(){
	...
	jQuery( ".organize-list li.active a" ).on("click",function(){
